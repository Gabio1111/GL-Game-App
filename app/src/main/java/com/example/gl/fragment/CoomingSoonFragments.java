...
public class CoomingSoonFragments extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_cooming_soon_fragments, container, false);

        ResponseFromAPI.getInstance().GetCoomingSoonGames(new IMyCallback() {

            @Override
            public <T> void onSuccess(@NonNull List<T> games) {
                featchDataToRecycleViewOfGames(R.id.recycler_view_cooming_soon_game, (List<GameModel>)games, root, container);
